...
class fft_estimator_cc(object):
    ...
    def make(fft_size, threshold):
        """
        make(size_t fft_size, float threshold) -> fft_estimator_cc_sptr
        ...
        Args:
            ...
            threshold : 
        """
        return _dslwp_swig.fft_estimator_cc_make(fft_size, threshold)
...
def fft_estimator_cc_make(fft_size, threshold):
    """
    fft_estimator_cc_make(size_t fft_size, float threshold) -> fft_estimator_cc_sptr
...
class fft_estimator_cc_sptr(object):
    ...
    def make(self, fft_size, threshold):
        """
        make(fft_estimator_cc_sptr self, size_t fft_size, float threshold) -> fft_estimator_cc_sptr
        ...
        Args:
            ...
            threshold : 
        """
        return _dslwp_swig.fft_estimator_cc_sptr_make(self, fft_size, threshold)
...
class ccsds_turbo_decode(object):
    ...
    def make(base=223, octets=1, code_type=1, iterations=2, sigma=0.707):
        """
        make(int base=223, int octets=1, int code_type=1, int iterations=2, float sigma=0.707) -> ccsds_turbo_decode_sptr
        ...
        Args:
            ...
            sigma : 
        """
        return _dslwp_swig.ccsds_turbo_decode_make(base, octets, code_type, iterations, sigma)
...
def ccsds_turbo_decode_make(base=223, octets=1, code_type=1, iterations=2, sigma=0.707):
    """
    ccsds_turbo_decode_make(int base=223, int octets=1, int code_type=1, int iterations=2, float sigma=0.707) -> ccsds_turbo_decode_sptr
...
class ccsds_turbo_decode_sptr(object):
    ...
    def make(self, base=223, octets=1, code_type=1, iterations=2, sigma=0.707):
        """
        make(ccsds_turbo_decode_sptr self, int base=223, int octets=1, int code_type=1, int iterations=2, float sigma=0.707) -> ccsds_turbo_decode_sptr
        ...
        Args:
            ...
            sigma : 
        """
        return _dslwp_swig.ccsds_turbo_decode_sptr_make(self, base, octets, code_type, iterations, sigma)
